...
const COPY = {
  de: {
    ...
    showcaseBody: "Ferrari 458 Italia in Zürich mieten oder ausleihen – bei deiner persönlichen Ferrari Vermietung mit klaren Tarifen und professioneller Übergabe.",
    heroTitleA: "Ferrari 458 Italia mieten",
    heroTitleB: "in Zürich ab CHF 440",
    heroSubtitle: "Luxury Obsession ist deine persönliche Ferrari Vermietung bei Zürich. Miete den sorgfältig gepflegten Ferrari 458 Italia ab CHF 440 für 3 Stunden und fahre ihn selbst. Hauptabholung ist in Nänikon nahe Zürich; andere Übergabeorte sind auf Anfrage möglich. Wähle deinen Tarif und sende direkt deine Wunschtermin-Anfrage.",
    ...
    requestSub: "Sende Wunschdatum, Uhrzeit und Abholort. Wir bestätigen Verfügbarkeit, Preis und Details persönlich.",
...
const SWITZERLAND_COPY = {
  de: {
    ...
    showcaseBody: "Ferrari Vermietung für die Schweiz: Miete den Ferrari 458 Italia mit persönlicher Übergabe, klaren Tarifen und transparent ausgewiesenen Liefergebühren.",
    showcaseCta: "Verfügbarkeit in der Schweiz anfragen",
    heroTitleA: "Ferrari 458 Italia mieten",
    heroTitleB: "in der Schweiz ab CHF 440",
    heroSubtitle: "Miete den Ferrari 458 Italia in der Schweiz ab CHF 440 für 3 Stunden. Die kostenlose Hauptabholung ist in Nänikon nahe Zürich. Lieferungen nach Zug, Luzern, St. Gallen und Aargau kosten CHF 140; nach Bern, Basel und Chur CHF 290. Wähle im Formular deinen Ort und erhalte eine persönliche Bestätigung ohne versteckte Lieferkosten.",
    pill0: "Ferrari 458 Italia",
    pill1: "Selbst fahren",
    ...
    requestSub: "Wähle Tarif, Datum, Uhrzeit und Übergabeort. Wir bestätigen Verfügbarkeit, Gesamtpreis und Übergabedetails persönlich.",
...
const DRIVE_COPY = {
  de: {
    ...
    showcaseBody: "Erlebe den Ferrari 458 Italia selbst am Steuer: eine echte Ferrari Miete mit persönlicher Einweisung, klaren Konditionen und Abholung nahe Zürich.",
    showcaseCta: "Ferrari-Fahrt anfragen",
    heroTitleA: "Ferrari 458 Italia",
    heroTitleB: "selber fahren ab CHF 440",
    heroSubtitle: "Miete den Ferrari 458 Italia und fahre ihn selbst – ab CHF 440 für 3 Stunden. Vor der Fahrt erhältst du eine persönliche Fahrzeugübergabe und Einweisung. Hauptabholung ist in Nänikon nahe Zürich; Mindestalter 21 Jahre und rückerstattbare Kaution ab CHF 1’500. Wähle deinen Tarif und frag deinen Termin direkt an.",
    pill0: "Du fährst selbst",
    ...
    packagesSub: "Von 3 Stunden mit unbegrenzten Kilometern bis zum ganzen Wochenende: Wähle das passende Selbstfahrer-Paket.",
    requestTitle: "Termin zum Ferrari selber fahren anfragen",
    requestSub: "Sende Wunschdatum, Uhrzeit, Paket und Abholort. Wir bestätigen Verfügbarkeit und alle Bedingungen persönlich.",
    formTitle: "Deine Ferrari-Fahrt",
    notesHint: "Gewünschte Route, Anlass und weitere Fragen zu deiner Ferrari-Fahrt",
    ...
    faqA1: "Ja. Du mietest den Ferrari 458 Italia als Selbstfahrer und sitzt selbst am Steuer. Vor der Abfahrt erhältst du eine persönliche Übergabe und Einweisung.",
  },
  en: {
...
const WEDDING_COPY = {
  de: {
    ...
    showcaseBody: "Miete den Ferrari 458 Italia als Hochzeitsauto in Zürich – für die Ankunft, Brautpaar-Fotos und eine Fahrt, persönlich und diskret geplant.",
    showcaseCta: "Hochzeit anfragen",
    heroTitleA: "Ferrari 458 Italia",
    heroTitleB: "für deine Hochzeit mieten",
    heroSubtitle: "Miete den Ferrari 458 Italia für deine Hochzeit in Zürich – für eine besondere Ankunft, Fotos mit dem Brautpaar oder eine stilvolle Ausfahrt. Wir stimmen Übergabe, Zeitfenster und Abholort persönlich auf deinen Hochzeitstag ab.",
    pill0: "Ferrari 458 Italia",
    ...
    packagesSub: "Für Ankunft und Fotos, einen Halbtag oder einen längeren Hochzeitstag: Wähle die passende Dauer und sende uns deinen Ablauf.",
    requestTitle: "Ferrari für deine Hochzeit anfragen",
    requestSub: "Sende Hochzeitsdatum, gewünschte Uhrzeit, Location und geplanten Einsatz. Wir bestätigen die Verfügbarkeit und stimmen die Übergabe persönlich mit dir ab.",
    formTitle: "Deine Hochzeitsanfrage",
...
const GIFT_COPY = {
  de: {
    ...
    showcaseBody: "Verschenke das Erlebnis, einen Ferrari 458 Italia selbst zu fahren – als Geschenk oder Gutschein mit flexibler Terminwahl und persönlicher Planung.",
    showcaseCta: "Gutschein anfragen",
    heroTitleA: "Ferrari 458 Italia Geschenk",
    heroTitleB: "als Gutschein ab CHF 440",
    heroSubtitle: "Verschenke ein echtes Ferrari-458-Italia-Erlebnis in Zürich. Der Gutschein kann für einen Geburtstag, eine Überraschung oder einen besonderen Anlass genutzt werden. Du wählst das Paket, die beschenkte Person vereinbart den Termin flexibel mit uns.",
    pill0: "Ferrari 458 Italia",
    ...
    packagesSub: "Wähle die gewünschte Fahrdauer und das Kilometerpaket. Die elektronische Geschenkkarte ist im Preis enthalten und der Termin kann später abgestimmt werden.",
    requestTitle: "Ferrari Gutschein anfragen",
    requestSub: "Wähle das gewünschte Paket und teile uns mit, für wen der Gutschein gedacht ist. Falls der Termin noch nicht feststeht, kann er später mit der beschenkten Person vereinbart werden.",
    formTitle: "Deine Gutscheinanfrage",
    ...
    faqA2: "Nein. Du kannst zuerst das Paket und die Geschenkkarte anfragen. Die beschenkte Person kann den verfügbaren Fahrtermin später persönlich mit uns abstimmen.",
...
function buildCityCopy(lang, city) {
  ...
  if (lang === "de") {
    return {
      ...
      heroTitleA: "Ferrari 458 Italia mieten",
      heroTitleB: locative,
      heroSubtitle: `Miete einen sorgfältig gepflegten Ferrari 458 Italia ${locative}. Die Lieferung ${deliveryPhrase} kostet CHF ${fee}. Die Tarife beginnen bei CHF 440; Übergabe, Konditionen und Termin werden persönlich bestätigt.`,
      pill0: "Ferrari 458 Italia",
      pill1: "V8-Saugmotor",
      ...
      requestSub: `${name} ist im Formular als Übergabeort vorausgewählt. Wähle Tarif, Datum und Uhrzeit; die Lieferkosten betragen CHF ${fee}.`,
